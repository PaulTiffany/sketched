...
import ForcingAnalysis.Book5StatefulOperatorLearning
...
import ForcingAnalysis.Book4ImaginaryRegulationCurvature
...
import ForcingAnalysis.Book7EventHorizonTetrad
...
import ForcingAnalysis.Book7QuadraticPolarization
import ForcingAnalysis.Book7GleasonBoundary
import ForcingAnalysis.Book7QuantumGleason
import ForcingAnalysis.Book7RegimeReconstruction
...
import ForcingAnalysis.Book9Stewardship
import ForcingAnalysis.Book9HopeDriver
...
import ForcingAnalysis.Book5AlignmentDynamics
...
import ForcingAnalysis.Book4AssembledConnection
import ForcingAnalysis.Book4GeodesicFailure
import ForcingAnalysis.Book4ObserverGeometry
import ForcingAnalysis.Book4Gauge
import ForcingAnalysis.Book4FuzzyStokes
import ForcingAnalysis.Book4WilsonGlobal
...
import ForcingAnalysis.ScholiumD
import ForcingAnalysis.ScholiumQuantumTensorNoGo
...
import ForcingAnalysis.Book2HypothesisSurfaceStokes
...
#print axioms Book3.exists_chart_membrane
#print axioms Book3.conditional_symbolic_membrane_wellposed
#print axioms Book3.perturbation_budget_does_not_supply_domain
...
#print axioms Book3Helmholtz.FiniteHodgeData.reconstruction
#print axioms Book3Helmholtz.FiniteHodgeData.harmonicComponent_mem
#print axioms Book3Helmholtz.FiniteHodgeData.exact_coexact_inner_eq_zero
#print axioms Book3Helmholtz.FiniteHodgeData.exact_harmonic_inner_eq_zero
#print axioms Book3Helmholtz.FiniteHodgeData.coexact_harmonic_inner_eq_zero
#print axioms Book3Helmholtz.FiniteHodgeData.harmonicComponent_eq_self_of_exact_eq_bot_of_coexact_eq_bot
#print axioms Book3Helmholtz.FiniteHodgeData.nonzero_harmonic_component_exists
#print axioms Book3Helmholtz.GlobalHodgeCertificate.components
#print axioms Book3Helmholtz.GlobalHodgeCertificate.refinement_energy_decomposes
#print axioms Book3Helmholtz.GlobalHodgeCertificate.harmonic_eq_zero_of_subsingleton_cohomology
#print axioms Book3Helmholtz.GlobalHodgeCertificate.operational_readout_reconstructs
#print axioms Book3Helmholtz.GlobalHodgeCertificate.multimodal_readout_reconstructs
#print axioms Book3Helmholtz.GlobalHodgeCertificate.faithful_readout_detects_harmonic
#print axioms Book3Helmholtz.unfaithful_readout_can_erase_harmonic
#print axioms Book3Helmholtz.harmonic_channel_can_be_operationally_detected
#print axioms Book3.assembled_network_stability_pos
#print axioms Book3.growth_alone_does_not_generate_network
#print axioms Book3.runNetworkEmergence_nodes
#print axioms Book3.runNetworkEmergence_edges
#print axioms Book3.runNetworkEmergence_edge_has_bridge
#print axioms Book3.runNetworkEmergence_stability
#print axioms Book3.runNetworkEmergence_stability_pos
#print axioms Book3.runNetworkEmergence_stability_pos_from_floor
#print axioms Book3.runNetworkEmergence_realizes_assembly
#print axioms Book3.same_growth_allows_distinct_nodes
...
#print axioms Book3CanonicalLife.operational_correspondence
#print axioms Book3CanonicalLife.operational_symbolic_life_satisfies_canonical
#print axioms Book3CanonicalLife.repair_improves_iff_morphological_error_decreases
#print axioms Book3CanonicalLife.operational_substrate_translation
#print axioms Book3CanonicalLife.operational_symbolic_life_realizes_canonical_demarcations
...
#print axioms ScholiumA.CoemergentPhaseProcess.ObserverPhaseCertificate.components
#print axioms ScholiumA.CoemergentPhaseProcess.zmod4_pair_nontrivial
...
#print axioms Book2CycleConsistency.cycleWork_eq_zero
#print axioms Book2CycleConsistency.entropyTemperatureHolonomy_eq_zero_of_integrable
#print axioms Book2CycleConsistency.thermodynamic_consistency_of_closed_integrable_cycle
#print axioms Book2CycleConsistency.consistency_iff_zero_entropyTemperatureHolonomy
#print axioms Book2CycleConsistency.path_thermodynamic_consistency
#print axioms Book2CycleConsistency.closed_cycle_can_have_nonzero_entropyTemperatureHolonomy
#print axioms Book2HypothesisSurfaceStokes.HypothesisSurfaceThermodynamics.boundary_balance_with_residue
#print axioms Book2HypothesisSurfaceStokes.HypothesisSurfaceThermodynamics.boundary_consistency_iff_residue_zero
#print axioms Book2HypothesisSurfaceStokes.HypothesisSurfaceThermodynamics.boundary_thermodynamic_consistency
#print axioms Book2HypothesisSurfaceStokes.HypothesisSurfaceThermodynamics.interior_thermodynamic_consistency
#print axioms Book2HypothesisSurfaceStokes.HypothesisSurfaceThermodynamics.interior_consistency_iff_residue_zero
#print axioms Book2HypothesisSurfaceStokes.scalar_closed_surface_consistent
#print axioms Book2HypothesisSurfaceStokes.bounded_curvature_does_not_zero_residue
...
#print axioms ScholiumC.OperationalStage.operators_coemerge
#print axioms ScholiumC.OperationalStage.drift_advances_stage
#print axioms ScholiumC.OperationalStage.observed_drift_ne_zero
#print axioms ScholiumC.CategoryOfStructures.existsUnique_from_empty
#print axioms ScholiumC.CategoryOfStructures.exists_colimit_cocone
#print axioms ScholiumC.CategoryOfStructures.hom_advances_stage
...
#print axioms Book5AlignmentDynamics.alignmentError_succ
#print axioms Book5AlignmentDynamics.alignmentError_tendsto_zero
#print axioms Book5AlignmentDynamics.realizedContribution_tendsto_margin
#print axioms Book5AlignmentDynamics.eventually_realizedContribution_pos
#print axioms Book5AlignmentDynamics.margin_sub_realizedContribution
#print axioms Book5AlignmentDynamics.ReflectiveAlignmentCertificate.realizes_reflective_drift_alignment
#print axioms Book5AlignmentDynamics.positive_margin_without_contraction_does_not_align
...
#print axioms Book5EquilibriumConservation.energy_rate_norm_linear_spectral_bound
...
#print axioms Book5EnhancedDuality.existsUnique_regimeCondition
...
#print axioms Book5TransitionDynamics.expEvolution_zero
#print axioms Book5TransitionDynamics.expEvolution_hasDerivAt
#print axioms Book5TransitionDynamics.expEvolution_add
#print axioms Book5TransitionDynamics.mapStep_eq_expEvolution
#print axioms Book5TransitionDynamics.madStep_eq_expEvolution
#print axioms Book5TransitionDynamics.solution_eq_shifted_expEvolution
#print axioms Book5TransitionDynamics.exact_step_of_constant_rate_ode
#print axioms Book5TransitionDynamics.constant_rate_ode_solution_unique
...
#print axioms ScholiumD.newtonian_incompleteness_normedSpace
#print axioms ScholiumD.symbolic_quantum_incompatibility_kernel
#print axioms ScholiumQuantumTensorNoGo.no_self_tensor_linearEquiv
#print axioms ScholiumQuantumTensorNoGo.no_lossless_tensor_closure
#print axioms ScholiumQuantumTensorNoGo.self_tensor_linearEquiv_exists_dim_one
#print axioms ScholiumQuantumTensorNoGo.self_tensor_finrank_eq_forces_one
#print axioms ScholiumD.emergence_premises_do_not_force_curvature
#print axioms ScholiumD.contextualGrowth_exposes_crossError
...
#print axioms Book4AssembledConnection.globalNablaAt_apply
#print axioms Book4AssembledConnection.globalNablaAt_eq_of_local_eq
#print axioms Book4AssembledConnection.assembledTorsionAt_eq_zero_of_local_symmetric
#print axioms Book4AssembledConnection.certified_coefficient_transformation
#print axioms Book4AssembledConnection.certified_jacobian_cocycle
#print axioms Book4AssembledConnection.discreteParallelTransport_append
#print axioms Book4AssembledConnection.singleton_globalNablaAt
#print axioms Book4AssembledConnection.ObserverFloorRegularity.coefficient_uses_observer_floor
#print axioms Book4AssembledConnection.EffectiveParallelTransportCertificate.solves_observer_floor_transport
#print axioms Book4AssembledConnection.EffectiveParallelTransportCertificate.eq_certified_trajectory
#print axioms Book4AssembledConnection.EffectiveParallelTransportCertificate.observed_endpoint_error_tendsto_zero
#print axioms Book4AssembledConnection.EffectiveParallelTransportCertificate.observed_endpoint_tendsto
#print axioms Book4AssembledConnection.observer_floor_can_change_visible_path
#print axioms Book4AssembledConnection.step_size_matters
...
#print axioms Book4GeodesicFailure.JacobiCertificate.acceleration_eq_neg_curvature
#print axioms Book4GeodesicFailure.norm_sq_error_bound
#print axioms Book4GeodesicFailure.norm_sq_error_bound_of_uniform
#print axioms Book4GeodesicFailure.JacobiCertificate.observer_diagnostic_certificate
...
#print axioms Book4ObserverGeometry.jointEquilibrium_iff
#print axioms Book4ObserverGeometry.equilibrium_constantTrajectory_solves
#print axioms Book4ObserverGeometry.exists_picardLindelof_certificate_of_locallyLipschitz
#print axioms Book4ObserverGeometry.locallyLipschitz_finiteDimensional_local_existence
#print axioms Book4ObserverGeometry.picardLindelof_local_existence
#print axioms Book4ObserverGeometry.picardLindelof_local_uniqueness
#print axioms Book4ObserverGeometry.CoupledAttractionCertificate.jointError_tendsto_zero
#print axioms Book4ObserverGeometry.translatingVectorField_has_no_jointEquilibrium
#print axioms Book4Gauge.derivative_correspondence_bijective
#print axioms Book4Gauge.curvature_correspondence_bijective
#print axioms Book4Gauge.StructuralGaugeCertificate.connectionAction_square
#print axioms Book4Gauge.StructuralGaugeCertificate.curvature_square
#print axioms Book4Gauge.StructuralGaugeCertificate.fieldAction_square
#print axioms Book4Gauge.StructuralGaugeCertificate.holonomy_square
#print axioms Book4Gauge.names_alone_do_not_supply_gauge_dictionary
#print axioms Book4Gauge.ObserverAtlas.global_unique_of_local_compatibility
#print axioms Book4Gauge.coordinateObserverAtlas_assembles
#print axioms Book4Gauge.observer_local_types_do_not_force_global_existence
#print axioms Book4Gauge.WilsonTransportCertificate.trajectory_initial
#print axioms Book4Gauge.WilsonTransportCertificate.trajectory_hasDerivWithinAt
#print axioms Book4Gauge.WilsonTransportCertificate.holonomy_eq_endpoint
...
#print axioms Book4FuzzyStokes.FuzzyStokesCertificate.fuzzy_stokes
#print axioms Book4FuzzyStokes.FuzzyStokesCertificate.classical_recovery
#print axioms Book4FuzzyStokes.FuzzyStokesCertificate.integrated_residue_zero_of_classical_recovery
#print axioms Book4FuzzyStokes.FuzzyStokesCertificate.interactionForm_eq_zero_of_classical_recovery
#print axioms Book4FuzzyStokes.cancellingInteraction_ne_zero
#print axioms Book4FuzzyStokes.cancellingInteraction_integral_eq_zero
#print axioms Book4FuzzyStokes.integrated_zero_does_not_force_form_zero
#print axioms Book4FuzzyStokes.sum_stripExteriorDerivative
#print axioms Book4FuzzyStokes.discrete_fuzzy_stokes
#print axioms Book4FuzzyStokes.discrete_classical_recovery
#print axioms Book4FuzzyStokes.RectangleFuzzyStokesData.exteriorDensity_integrable
#print axioms Book4FuzzyStokes.RectangleFuzzyStokesData.rectangle_stokes
#print axioms Book4FuzzyStokes.RectangleFuzzyStokesData.analytic_fuzzy_stokes
#print axioms Book4FuzzyStokes.RectangleFuzzyStokesData.analytic_classical_recovery
#print axioms Book4FuzzyStokes.RectangleFuzzyStokesData.analytic_curvature_transports_through_gauge
#print axioms Book4FuzzyStokes.FuzzyStokesAtlasCertificate.assembled_fuzzy_stokes
#print axioms Book4FuzzyStokes.FuzzyStokesAtlasCertificate.assembled_classical_recovery
#print axioms Book4WilsonGlobal.WilsonContinuationTrace.chartAt_mem
#print axioms Book4WilsonGlobal.WilsonContinuationTrace.globalTransport_eq_local
#print axioms Book4WilsonGlobal.WilsonContinuationTrace.globalHolonomy_eq_endpoint_of_initial_eq_one
#print axioms Book4WilsonGlobal.AnalyticWilsonContinuationTrace.globalTransport_eq_certified_trajectory
#print axioms Book4WilsonGlobal.AnalyticWilsonContinuationTrace.local_trajectory_hasDerivWithinAt
#print axioms Book4WilsonGlobal.reverseOrderedIncrements_prod
#print axioms Book4WilsonGlobal.exact_partition_transport_eq_holonomy
#print axioms Book4WilsonGlobal.wilsonObservable_eq_trace
#print axioms Book4WilsonGlobal.symbolic_loop_has_wilson_representation
#print axioms Book4WilsonGlobal.endpoint_alone_does_not_identify_symbolic_loop
#print axioms Book4WilsonGlobal.ObserverWilsonApproximationCertificate.observed_error_tendsto_zero
#print axioms Book4WilsonGlobal.ObserverWilsonApproximationCertificate.observed_approximation_tendsto
#print axioms Book4WilsonGlobal.ObserverWilsonApproximationCertificate.admissible_iff_visible_above_floor
#print axioms Book4WilsonGlobal.CrossObserverWilsonTransport.transported_target_eq
#print axioms Book4WilsonGlobal.CrossObserverWilsonTransport.transported_approximation_eq
#print axioms Book4WilsonGlobal.shared_raw_endpoint_does_not_force_shared_observation
#print axioms Book4WilsonGlobal.positive_resolution_floor_not_unique
#print axioms Book4WilsonGlobal.scalarConstantEulerApproximation_tendsto
#print axioms Book4WilsonGlobal.scalarConstantObserverCertificate_tendsto
...
#print axioms Book4QuantumGeometry.certified_gauge_action_natural
#print axioms Book4QuantumGeometry.certified_curvature_natural
#print axioms Book4QuantumGeometry.certified_holonomy_natural
#print axioms Book4QuantumGeometry.certified_quantum_fluctuation_iff_symbolic
#print axioms Book4QuantumGeometry.equivalences_alone_do_not_force_quantum_geometry_certificate
...
#print axioms Book4MetricLearning.positiveMetric_pos
#print axioms Book4MetricLearning.metricLearningStep_strict_descent
#print axioms Book4MetricLearning.learnedParameter_zero
#print axioms Book4MetricLearning.learnedParameter_succ
#print axioms Book4MetricLearning.learnedMetric_positive
#print axioms Book4MetricLearning.learnedParameter_tendsto_target
#print axioms Book4MetricLearning.target_identified_from_equal_readout
#print axioms Book4MetricLearning.positiveMetric_injective
#print axioms Book4MetricLearning.certified_metric_learning
...
#print axioms Book4InformationCurvature.fisherMetric_symm
#print axioms Book4InformationCurvature.fisherMetric_diagonal_nonneg
#print axioms Book4InformationCurvature.riemannCurvature_swap
#print axioms Book4InformationCurvature.riemannCurvature_diagonal_zero
#print axioms Book4InformationCurvature.christoffel_eq_zero_of_dMetric_zero
#print axioms Book4InformationCurvature.riemannCurvature_eq_zero_of_constant_jet
#print axioms Book4InformationCurvature.unit_hessianMoment_diagonal
#print axioms Book4InformationCurvature.hessianMoment_is_not_riemannCurvature
...
#print axioms Book4FieldRegularization.regularizeField_passband
#print axioms Book4FieldRegularization.regularizeField_stopband
#print axioms Book4FieldRegularization.regularizeField_add
#print axioms Book4FieldRegularization.regularizeField_smul
#print axioms Book4FieldRegularization.regularizeField_idempotent
#print axioms Book4FieldRegularization.regularized_support_bounded
#print axioms Book4FieldRegularization.accessibleAssignment_card
#print axioms Book4FieldRegularization.fixedOrderDiagram_zero
#print axioms Book4FieldRegularization.fixed_orders_do_not_force_all_orders_control
...
#print axioms Book4QuantumMeasurement.trace_partialTraceEnvironment
#print axioms Book4QuantumMeasurement.jointExpectation_local_eq_reduced
#print axioms Book4QuantumMeasurement.trace_pureStateDensity_mul
#print axioms Book4QuantumMeasurement.observerMetric_eq_reduced
#print axioms Book4QuantumResolution.inducedMetric_symmetric
#print axioms Book4QuantumResolution.inducedMetric_diagonal_nonneg
#print axioms Book4QuantumResolution.inducedMetric_zero_of_response_zero
#print axioms Book4QuantumResolution.inducedMetric_diagonal_pos_of_channel
#print axioms Book4QuantumResolution.quantum_resolution_constructs_observer_metric
#print axioms Book4QuantumResolution.reduced_state_does_not_determine_resolution_kernel
...
#print axioms Book4StatisticalMechanics.coarseObserverMetric_symmetric
#print axioms Book4StatisticalMechanics.metricQuadratic_ensembleMetric
#print axioms Book4StatisticalMechanics.metricQuadratic_thermalMetric
#print axioms Book4StatisticalMechanics.coarseObserverMetric_psd
#print axioms Book4StatisticalMechanics.ensembleMetric_of_constant
...
#print axioms Book4Holographic.reconstructedEntropy_nonneg
#print axioms Book4Holographic.selectedSurface_minimizes_entropy
#print axioms Book4Holographic.selectedSurface_unique_of_uniqueMinimizer
#print axioms Book4Holographic.minimal_area_does_not_force_unique_surface
...
#print axioms Book5Hysteresis.ActivationBarrier.threshold_gap
#print axioms Book5Hysteresis.ActivationBarrier.energy_eq
#print axioms Book5Hysteresis.ActivationBarrier.energy_pos
#print axioms Book5Hysteresis.runHysteresis_in_band
#print axioms Book5Hysteresis.same_in_band_path_retains_distinct_histories
...
#print axioms Book5DualityProof.covenantTrajectory_tendsto_target
#print axioms Book5DualityProof.map_target_eventually_viable
#print axioms Book5DualityProof.covenantTrajectory_orientation_dual
#print axioms Book5DualityProof.mad_target_eventually_collapsed
#print axioms Book5DualityProof.geometric_decoupling_vanishes
#print axioms Book5DualityProof.decoupling_without_contraction_can_persist
#print axioms Book5DualityProof.EnhancedDualityRealizationCertificate.map_realization
#print axioms Book5DualityProof.EnhancedDualityRealizationCertificate.mad_realization
#print axioms Book5DualityProof.EnhancedDualityRealizationCertificate.decoupling_realization
#print axioms Book5DualityProof.EnhancedDualityRealizationCertificate.enhanced_map_mad_dynamical_realization
...
#print axioms Book5StrategyBalance.OperatorStrategySpace.exists_operator_balance_of_cofinal
#print axioms Book5StrategyBalance.OperatorStrategySpace.viableMAP_nonempty_of_richness
#print axioms Book5StrategyBalance.OperatorStrategySpace.mem_viableMAP_iff
#print axioms Book5StrategyBalance.OperatorStrategySpace.viableMAP_eq_isMAP_of_uniform_richness
#print axioms Book5StrategyBalance.OperatorStrategySpace.submaximal_drift_without_inventory_countermodel
...
#print axioms Book5ConvergenceMAP.PersistentMAPAdvantage.contraction_nonneg
#print axioms Book5ConvergenceMAP.PersistentMAPAdvantage.contraction_lt_one
#print axioms Book5ConvergenceMAP.MAPPopulationOrbit.residual_eq_pow
#print axioms Book5ConvergenceMAP.MAPPopulationOrbit.share_le_one
#print axioms Book5ConvergenceMAP.MAPPopulationOrbit.share_nonneg
#print axioms Book5ConvergenceMAP.MAPPopulationOrbit.share_eq_mapShare
#print axioms Book5ConvergenceMAP.MAPPopulationOrbit.share_tendsto_one
#print axioms Book5ConvergenceMAP.MAPPopulationOrbit.fitness_gap_with_inflow_does_not_force_convergence
...
#print axioms Book5ESSEquivalence.TwoSidedStrategyApproximation.hausdorffDist_le
#print axioms Book5ESSEquivalence.TwoSidedStrategyApproximation.hausdorffDist_tendsto_zero
#print axioms Book5ESSEquivalence.TwoSidedStrategyApproximation.of_eventual_equality
#print axioms Book5ESSEquivalence.one_sided_ess_to_map_does_not_identify_sets
#print axioms Book5ESSEquivalence.population_limit_does_not_supply_two_sided_approximation
...
#print axioms Book5StatefulOperatorLearning.step_current
#print axioms Book5StatefulOperatorLearning.step_records_incumbent
#print axioms Book5StatefulOperatorLearning.step_comparatorRegret_nonpos
#print axioms Book5StatefulOperatorLearning.boolFeedbackLaw_responds
#print axioms Book5StatefulOperatorLearning.two_steps_retain_ordered_history
#print axioms Book5StatefulOperatorLearning.feedback_response_does_not_force_inventory_change
...
#print axioms Book5ReflectiveAccuracy.ReflectiveFidelityProcess.fidelity_le_linear
#print axioms Book5ReflectiveAccuracy.GeometricRecursionBudget.power_le_capacity_ratio_add_one
#print axioms Book5ReflectiveAccuracy.ReflectiveAccuracyCertificate.beta_nonneg
#print axioms Book5ReflectiveAccuracy.ReflectiveAccuracyCertificate.fidelity_le_log_capacity
#print axioms Book5ReflectiveAccuracy.depth_budget_without_marginal_control_countermodel
...
#print axioms Book5ShadeTransfer.ShadeInterface.faithful_comp
#print axioms Book5ShadeTransfer.ShadeInterface.identity_faithful
#print axioms Book5ShadeTransfer.faithfulControlTransport_components
#print axioms Book5ShadeTransfer.radius_preservation_implies_control_fidelity
#print axioms Book5ShadeTransfer.shade_without_shadow_price_is_not_control_fidelity
#print axioms Book5ShadeTransfer.monotone_encoding_not_semantically_faithful
...
#print axioms Book6DriftMutation.MutationConstitutiveCertificate.rate_nonneg
#print axioms Book6DriftMutation.MutationConstitutiveCertificate.rate_le_calibrated_uniform_bound
...
#print axioms Book6ThermodynamicMutation.MEPPSelectionLaw.trajectory_tendsto
#print axioms Book6ThermodynamicMutation.argmax_exists_without_selection_dynamics
...
#print axioms Book6ConfidenceGradient.confidenceVelocity_descends_of_perturbation_control
#print axioms Book6ConfidenceGradient.confidenceVelocity_strictly_descends_of_strict_control
...
#print axioms Book4ImaginationGuard.opposite_phases_cancel_projection_not_exposure
#print axioms Book4ImaginationGuard.phaseBudget_nonneg
#print axioms Book4ImaginationGuard.certifiedRate_lt_one_of_penalty_below_margin
#print axioms Book4ImaginationGuard.linearPhaseRateLaw_recovers_effectiveRate
#print axioms Book4ImaginationGuard.zero_calibration_alone_does_not_determine_rate
...
#print axioms Book4ImaginaryRegulationCurvature.reintegrationResidue_iff_noncommuting
#print axioms Book4ImaginaryRegulationCurvature.residue_implies_imaginationActive
#print axioms Book4ImaginaryRegulationCurvature.imagination_alone_does_not_force_residue
#print axioms Book4ImaginaryRegulationCurvature.curvature_alone_does_not_force_imagination
#print axioms Book4ImaginaryRegulationCurvature.imaginaryTraversalCost_nonneg
#print axioms Book4ImaginaryRegulationCurvature.imaginaryTraversalCost_eq_zero_iff
#print axioms Book4ImaginaryRegulationCurvature.imaginaryTraversalCost_pos_iff
#print axioms Book4ImaginaryRegulationCurvature.weightedTraversalCost_nonneg
#print axioms Book4ImaginaryRegulationCurvature.weightedTraversalCost_pos_iff
#print axioms Book4ImaginaryRegulationCurvature.weightedTraversalCost_mono_gravity
#print axioms Book4ImaginaryRegulationCurvature.zero_gravity_zero_cost
#print axioms Book4ImaginaryRegulationCurvature.CurvatureCostCertificate.curvature_nonneg
#print axioms Book4ImaginaryRegulationCurvature.CurvatureCostCertificate.curvature_pos_iff
#print axioms Book4ImaginaryRegulationCurvature.CurvatureCostCertificate.curvature_zero_of_free_reintegration
#print axioms Book4ImaginaryRegulationCurvature.active_imagination_can_have_zero_traversalCost
#print axioms Book4ImaginaryRegulationCurvature.operationalControl_components
#print axioms Book4ImaginaryRegulationCurvature.accumulatedResidue_succ
#print axioms Book4ImaginaryRegulationCurvature.accumulatedResidue_strictMono
#print axioms Book4ImaginaryRegulationCurvature.accumulatedResidue_ne_initial
...
#print axioms Book6ConfidenceStability.ConfidenceStabilityCertificate.velocity_nonpos
...
#print axioms Book6ObserverExtension.ObserverOperatorExtensionCertificate.exists_total_extension
#print axioms Book6ObserverExtension.ObserverOperatorExtensionCertificate.joint_defect_bound
...
#print axioms Book8OrientationSignposting.encode_eq_orientationSign_mul
#print axioms Book8OrientationSignposting.transport_eq_relativeSign_mul
#print axioms Book8OrientationSignposting.transport_trans
#print axioms Book8OrientationSignposting.transport_roundtrip
#print axioms Book8OrientationSignposting.transport_positive_of_same_orientation
#print axioms Book8OrientationSignposting.transport_negative_of_opposite_orientation
#print axioms Book7SystemicPower.localPower_pos
#print axioms Book7SystemicPower.orientedLocalPower_pos
...
#print axioms Book7NoInteriorTransition.regularizedGeometry_continuousOn
#print axioms Book7NoInteriorTransition.regularizedGeometry_has_no_interior_transition
#print axioms Book7NoInteriorTransition.subcriticalLpExponent_zero_curvature
#print axioms Book7NoInteriorTransition.subcriticalLpExponent_continuousOn
#print axioms Book7NoInteriorTransition.subcriticalLpExponent_strict_order
#print axioms Book7NoInteriorTransition.subcriticalLpExponent_has_no_interior_transition
...
#print axioms Book7NoncontextualHilbert.translate_square_commutes
#print axioms Book7NoncontextualHilbert.commuting_transport_does_not_force_metric_parallelogram
#print axioms Book7NoncontextualHilbert.quadraticEnergy_parallelogram
#print axioms Book7NoncontextualHilbert.innerProductSpace_exists_of_metric_parallelogram
#print axioms Book7EventHorizonTetrad.reconstructedValue_eq
#print axioms Book7EventHorizonTetrad.mixedCoefficient_eq_zero_iff_separable
#print axioms Book7EventHorizonTetrad.nonzero_mixedCoefficient_iff_nonseparable
#print axioms Book7EventHorizonTetrad.tetrad_reconstruction_does_not_force_hilbert_metric
...
#print axioms Book6ThermodynamicMAP.AveragedConstitutiveLaw.thermodynamicMAPDuality
#print axioms Book6ThermodynamicMAP.AveragedConstitutiveLaw.dualityResidual_eq_zero
...
#print axioms Book7BornCollapse.finiteBornValue_nonneg
#print axioms Book7BornCollapse.finiteBornValue_sum_one
#print axioms Book7BornCollapse.amplitudeCalibratedReadout_unique
#print axioms Book7BornCollapse.zero_curvature_hilbert_finiteBorn
#print axioms Book7BornCollapse.finiteBornValue_amplitudeOfProbability
#print axioms Book7BornCollapse.finite_probability_has_born_representation
#print axioms Book7BornCollapse.amplitudeOfProbability_normalized
#print axioms Book7BornCollapse.normalization_alone_does_not_force_finiteBorn
#print axioms Book7FrameMeasure.FrameReadoutSystem.globalValue_eq_local
#print axioms Book7FrameMeasure.FrameReadoutSystem.globalValue_nonnegative
#print axioms Book7FrameMeasure.FrameReadoutSystem.globalValue_normalized_on_frame
#print axioms Book7FrameMeasure.FrameReadoutSystem.globalValue_unique
#print axioms Book7FrameMeasure.FrameReadoutSystem.globalValue_eq_finiteBorn
#print axioms Book7FrameMeasure.noncontextual_gluing_alone_does_not_force_born
#print axioms Book7QuadraticTrace.quadratic_eq_trace_pureStateDensity_mul
#print axioms Book7QuadraticTrace.FrameReadoutSystem.globalValue_eq_trace_of_quadratic
#print axioms Book7QuadraticTrace.gluing_requires_quadratic_existence_bridge
#print axioms Book7QuadraticPolarization.quadraticForm_has_symmetric_bilinear_representation
#print axioms Book7QuadraticPolarization.associated_diagonal_nonnegative
#print axioms Book7QuadraticPolarization.nonnegative_readout_does_not_force_quadratic
#print axioms Book7QuadraticPolarization.QuadraticReadoutLaws.toQuadraticForm_apply
#print axioms Book7QuadraticPolarization.QuadraticReadoutLaws.roundtrip_value
#print axioms Book7QuadraticPolarization.certified_readout_has_symmetric_bilinear_representation
#print axioms Book7GleasonBoundary.quarticFrameValue_nonnegative
#print axioms Book7GleasonBoundary.quarticFrameValue_smul
#print axioms Book7GleasonBoundary.quartic_orthogonal_pair_normalized
#print axioms Book7GleasonBoundary.quadraticForm_parallelogram
#print axioms Book7GleasonBoundary.quartic_frame_function_is_not_quadratic
#print axioms Book7GleasonBoundary.rank_two_frame_axioms_do_not_force_born
#print axioms Book7QuantumGleason.vectorExpectation_smul
#print axioms Book7QuantumGleason.vectorExpectation_globalPhase
#print axioms Book7QuantumGleason.complex_phase_refutes_real_degreeTwo
#print axioms Book7QuantumGleason.operatorQuantumRayReadout_globalPhase
#print axioms Book7QuantumGleason.HermitianReadoutCertificate.toSesquilinear_apply
#print axioms Book7QuantumGleason.HermitianReadoutCertificate.toSesquilinear_isSymm
#print axioms Book7QuantumGleason.HermitianReadoutCertificate.toSesquilinear_diagonal
#print axioms Book7QuantumGleason.HermitianReadoutCertificate.value_smul
#print axioms Book7QuantumGleason.hermitian_reconstruction_from_certificate
#print axioms Book7QuantumGleason.completeFrameCoherence_does_not_supply_hermitian_certificate
#print axioms Book7QuantumGleason.quantumResolution_to_hermitian_certificate
#print axioms Book7QuantumGleason.quantumResolution_without_matrixHermiticity_does_not_supply_certificate
#print axioms Book7QuantumGleason.quantumResolution_does_not_force_reducedState_isHermitian
#print axioms Book7QuantumGleason.pureStateDensity_isHermitian
#print axioms Book7QuantumGleason.pureStateToResolution_reducedState_isHermitian
#print axioms Book7QuantumGleason.pureState_forward_chain
#print axioms Book7QuantumGleason.pureStateDensity_globalPhase
#print axioms Book7QuantumGleason.pureStateToResolution_globalPhase
#print axioms Book7QuantumGleason.pureState_lowering_not_injective
#print axioms Book7RegimeReconstruction.RegimeEstimate.latent_critical_within_error
#print axioms Book7RegimeReconstruction.RegimeEstimate.latent_critical_lt_of_rhoHat_margin
#print axioms Book7RegimeReconstruction.RegimeEstimate.lt_latent_critical_of_margin
#print axioms Book7RegimeReconstruction.same_rhoHat_does_not_identify_latent
#print axioms Book7RegimeReconstruction.regime_does_not_determine_rhoO
#print axioms Book7RegimeReconstruction.RegimeEstimate.reframe_rhoHat
#print axioms Book7RegimeReconstruction.RegimeEstimate.reframe_order_iff
#print axioms Book7RegimeReconstruction.RegimeEstimate.reframe_threshold_iff
#print axioms Book7RegimeReconstruction.ordinal_agreement_does_not_identify_scale
...
#print axioms Book9Stewardship.safeguarded_child_of_preserving_derivation
#print axioms Book9Stewardship.release_evidence_supports_child
#print axioms Book9Stewardship.release_requires_valid_authority
#print axioms Book9Stewardship.safeguarded_parent_does_not_force_safeguarded_child
#print axioms Book9Stewardship.preservation_and_evidence_do_not_force_authority
#print axioms Book9HopeDriver.residual_pos_iff
#print axioms Book9HopeDriver.bounded_capacity_unbounded_drive_produces_breach
#print axioms Book9HopeDriver.hope_drives_change
#print axioms Book9HopeDriver.hope_alone_does_not_force_shared_good
...
#print axioms Book7B.budgetLimited_existsUniqueMinimizer_of_compact
#print axioms Book4Meaning.identityMeaning_nonneg_on_accessible
#print axioms Book4Meaning.identityMeaning_pos_iff_on_accessible
#print axioms Book4Meaning.identityMeaning_is_nontrivial
#print axioms Book4Meaning.identityMeaning_ceiling_witness_has_zero_value
#print axioms Book4Meaning.identityMeaning_strict_preference_iff
#print axioms Book4Meaning.preferentialFlow_meaning_nondecreasing
#print axioms Book4Meaning.transition_with_bridge_generates_positive_meaning
#print axioms Book4Meaning.retained_distinction_does_not_force_action_distinction
#print axioms Book4Meaning.value_map_does_not_determine_significance
end ForcingAnalysis
