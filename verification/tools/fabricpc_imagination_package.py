...
ARTIFACTS: tuple[str, ...] = (
    ...
    "verification/tools/fabricpc_orientation_adapter.py",
    "verification/tools/fabricpc_imagination_package.py",
    "docs/31_FABRICPC_IMAGINATION_PACKAGE.md",
    "docs/32_FABRICPC_MAINTAINER_HANDOFF.md",
    "contrib/fabricpc-trajectory-probe/README.md",
    "contrib/fabricpc-trajectory-probe/EXAMPLE.md",
    "contrib/fabricpc-trajectory-probe/presentation/index.html",
    "contrib/fabricpc-trajectory-probe/tennessee-eastman/README.md",
    "contrib/fabricpc-trajectory-probe/tennessee-eastman/SOURCE.json",
    "contrib/fabricpc-trajectory-probe/tennessee-eastman/run.ps1",
    "contrib/fabricpc-trajectory-probe/run.ps1",
    "contrib/fabricpc-trajectory-probe/PACKAGE.json",
    "verification/tep_fault1_certificate.json",
    "verification/tep_fabricpc_predictive_coding.json",
    "verification/tep_fabricpc_alarm_router.json",
    "verification/tools/tep_trajectory_probe.py",
    "verification/tools/tep_fabricpc_predictive_coding.py",
    "verification/tools/tep_fabricpc_alarm_router.py",
    "verification/tools/test_tep_fabricpc_predictive_coding.py",
    "verification/tools/test_tep_trajectory_probe.py",
)
